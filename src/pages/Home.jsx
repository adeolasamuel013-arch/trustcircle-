...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section style={{ background: 'var(--green)', padding: '4rem 1.25rem' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.75)', textAlign: 'center', fontSize: 16, lineHeight: 1.8, maxWidth: 560, margin: '0 auto 2.5rem' }}>
            Every Nigerian asks this on WhatsApp. You get 10 different names. Still don't know who to trust. TrustCircle fixes this forever.
          </p>
          <div className="compare-grid">
            {[
              { icon: '❌', title: 'Before TrustCircle', bg: 'rgba(255,255,255,0.06)', points: ['Random Google reviews', 'Strangers with fake ratings', 'Post on WhatsApp and pray', 'Risk getting scammed'] },
              { icon: '✅', title: 'With TrustCircle', bg: 'rgba(46,204,138,0.15)', points: ['Real people vouch for them', 'AI trust score from your network', 'Find verified professionals', 'Safe and transparent always'] },
      ...
      <section style={{ padding: '4rem 1.25rem', background: 'var(--cream)' }}>
        <div style={{ maxWidth: 1000, margin: '0 auto' }}>
          <h2 style={{ fontSize: 'clamp(1.6rem, 5vw, 2.5rem)', color: 'var(--green)', textAlign: 'center', marginBottom: '2rem' }}>Why Nigerians love TrustCircle</h2>
          <div className="testimonials-grid">
            {[
              { q: 'I found my mechanic through TrustCircle. He was vouched by 3 people I know personally. Transparent pricing and excellent work.', n: 'Funke A.', l: 'Lagos' },
              { q: 'As a lawyer, my reputation is everything. TrustCircle lets clients verify me before they call. My client base has grown massively.', n: 'Emeka O.', l: 'Abuja' },
              { q: 'I was scammed by a fake electrician before. Now I only use TrustCircle. The trust score system actually works — real referrals only.', n: 'Blessing I.', l: 'Port Harcourt' },
            ].map(({ q, n, l }) => (
      ...
      <section style={{ padding: '4rem 1.25rem', background: 'white' }}>
        <div style={{ maxWidth: 680, margin: '0 auto' }}>
          ...
          {[
            { q: 'Is TrustCircle free to use?', a: 'Yes — joining, vouching for people and searching for services is completely free. Always.' },
            ...
            { q: 'I signed up but cannot log in — why?', a: 'Check your email inbox for a confirmation email from Supabase and click the link inside. After that you can log in immediately.' },
      ...
      <footer style={{ padding: '2rem 1.25rem', borderTop: '1px solid var(--border)', textAlign: 'center' }}>
        <p style={{ fontFamily: 'Fraunces, serif', fontWeight: 700, fontSize: 17, color: 'var(--green)', marginBottom: 6 }}>TrustCircle</p>
