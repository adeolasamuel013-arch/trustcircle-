// All icons are clean SVG — no emojis anywhere
// Usage: <Icon name="mechanic" size={24} color="currentColor" />
...
const icons = {
  ...
  tailor: (size, color) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M6 9l12 3M6 15l12-3"/>
    </svg>
  ),
  hairstylist: (size, color) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="8" r="5"/><path d="M12 13v9"/><path d="M9 18h6"/>
    </svg>
  ),
  photographer: (size, color) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  painter: (size, color) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M22 8L12 2 2 8h20z"/>
      <line x1="12" y1="2" x2="12" y2="22"/>
      <line x1="2" y1="13" x2="22" y2="13"/>
    </svg>
  ),
  realestate: (size, color) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/>
      <polyline points="9 22 9 12 15 12 15 22"/>
    </svg>
  ...
  heart: (size, color, filled) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={filled ? '#E53E3E' : 'none'} stroke={filled ? '#E53E3E' : color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  trophy: (size, color) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <polyline points="8 3 4 3 4 9 8 9"/><polyline points="16 3 20 3 20 9 16 9"/>
      <path d="M12 15v4"/><line x1="9" y1="19" x2="15" y2="19"/>
...
export default function Icon({ name, size = 20, color = 'currentColor', filled = false, style = {} }) {
  ...
  return (
    <span style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, ...style }}>
      {fn(size, color, filled)}
    </span>
  )
}

// Service category config — maps skill names to icon names
