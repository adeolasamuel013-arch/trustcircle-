    ...
    <div style={{ background: 'var(--sand)' }}>
      ...
      <section className="hero grain">
        ...
        <div className="hero-left">
          ...
          <p className="hero-body fade-up-3">
            Every Nigerian knows the pain of trusting the wrong person. TrustCircle fixes that — with real vouches from real people whose own reputation is on the line.
          </p>
        ...
        <div className="problem-inner">
          <div className="problem-text-col reveal">
            ...
            <p className="problem-sub">
              Every Nigerian has asked this question. You post on WhatsApp, get ten different names, pick one randomly and hope for the best. TrustCircle ends that cycle — permanently.
            </p>
          </div>
      ...
      <section className="testimonials-section">
        <div className="testimonials-inner">
          <div className="testimonials-header">
            ...
            <p className="testimonials-body reveal">Real stories from real people who found trusted professionals — or built their own trusted reputation — on TrustCircle.</p>
          </div>
          <div className="testimonials-grid">
            {[
              { q: 'I found my mechanic through TrustCircle. He was vouched by three people I personally know. Transparent pricing, excellent work, on time.', name: 'Funke A.', loc: 'Lagos' },
              { q: 'As a lawyer, my reputation is everything. TrustCircle lets clients see my real vouches before they call. My client base has grown massively.', name: 'Emeka O.', loc: 'Abuja' },
              { q: 'I was scammed by a fake electrician before. Now I only use TrustCircle. Real referrals from people with skin in the game — it works.', name: 'Blessing I.', loc: 'Port Harcourt' },
            ].map(({ q, name, loc }, i) => (
      ...
      <section className="faq-section">
        <div className="faq-inner">
          ...
          {[
            { q: 'Is TrustCircle free to join?', a: 'Yes — completely free. Joining, vouching for people and searching for services costs nothing. Always.' },
      ...
      <section className="cta-section">
        ...
        <div className="cta-inner">
          ...
          <h2 className="cta-title reveal-2">
            Nigeria runs on<br />"who you know."<br /><em>Now it runs on TrustCircle.</em>
          </h2>
      ...
      <footer className="footer">
        <div className="footer-inner">
          <div className="footer-brand">TrustCircle</div>
          ...
          <div className="footer-copy">© 2026 TrustCircle — Built for Nigeria</div>
        </div>
      </footer>
    </div>
  )
